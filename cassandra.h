...
BIGGER,TWOP,ACOLO,ACOLF,USING,CROPEN,CRCLOSE,ENTER,POINT,QST,TRUE,TTL,APOST,FALSE,PER,DISTINCT,CAST,JSON,TOKEN,NOEQ,LESSEQ,BIGEQ,TO_TOKEN,QUOTED_NAME,AS,COUNT,UNQUOTED_NAME,IN,CONTAINS,CONT_KEY,DESC,ASC ,LIMIT,ALLOW,ORDER,GROUP,SELECT,HEX,BOOLEAN,SMALLINT,DATE,ERRORLEX,TIME,TINYINT,STRING_TOKEN} typetoken; 
